...
CREATE OR REPLACE PACKAGE VENTAS.PKG_PRODUCTO AS
...
CREATE OR REPLACE PACKAGE BODY VENTAS.PKG_PRODUCTO AS
...
BEGIN
  ...
  END IF;
	...
	--INSERTA REGISTRO
	INSERT INTO VENTAS.PRODUCTO(CODPROD,NOMBRE,MARCA,PRECIO,DESCUENTO,STOCK,FECHA_ACTUALIZACION,DESCRIPCION,CODCAT,CODUNI) 
...
CREATE OR REPLACE PACKAGE VENTAS.PKG_VENTA AS
...
CREATE OR REPLACE PACKAGE BODY VENTAS.PKG_VENTA AS
...
BEGIN
  ...
  END IF;
	...
	--INSERTA REGISTRO
	INSERT INTO VENTAS.VENTA(CODVEN,FECHA,TOTAL,FACTURA,CODCLI) 
...
CREATE OR REPLACE PACKAGE VENTAS.PKG_DETALLE_VENTA AS
...
CREATE OR REPLACE PACKAGE BODY VENTAS.PKG_DETALLE_VENTA AS
...
BEGIN
  ...
  END IF;
	...
	--INSERTA REGISTRO
	INSERT INTO VENTAS.DETALLE_VENTA(CODDETVEN,CODVEN,CODPROD,CANTIDAD,PRECIO,SUBTOTAL) 
...
CREATE OR REPLACE PACKAGE VENTAS.PKG_CLIENTE AS
...
CREATE OR REPLACE PACKAGE BODY VENTAS.PKG_CLIENTE AS
...
BEGIN
  ...
  END IF;
	...
	--INSERTA REGISTRO
	INSERT INTO VENTAS.CLIENTE(CODCLI,APELLIDOS,NOMBRE,DIRECCION,EMAIL,TELEFONO) 
...
CREATE OR REPLACE PACKAGE VENTAS.PKG_PAGO AS
...
CREATE OR REPLACE PACKAGE BODY VENTAS.PKG_PAGO AS
...
BEGIN
  ...
  END IF;
	...
	--INSERTA REGISTRO
	INSERT INTO VENTAS.PAGO(CODPAG,FECHA,MONTO_PAGADO,SALDO,OBSERVACION,CODVEN) 
...
CREATE OR REPLACE PACKAGE VENTAS.PKG_UTIL AS
...
CREATE OR REPLACE PACKAGE BODY VENTAS.PKG_UTIL AS
