...
DATAFILE 'H:\APP\TBS\XDF_COMPROBANTES_ASIA.DBF'
SIZE 10M;

CREATE TABLESPACE TBSX_EUROPA
DATAFILE 'H:\APP\TBS\XDF_COMPROBANTES_EUROPA.DBF'
SIZE 10M;

CREATE TABLESPACE TBSX_AL
DATAFILE 'H:\APP\TBS\XDF_COMPROBANTES_AL.DBF'
SIZE 10M;
  
CREATE TABLESPACE TBSX_OTROS
DATAFILE 'H:\APP\TBS\XDF_COMPROBANTES_OTROS.DBF'
SIZE 10M;
...
SELECT * FROM SCOTT.VENTAS PARTITION (ventas_EUROPA);
